...
<head>
<body><table border="1"> <div id="colorpicker" width="50%">		<div style = "clear:both" width="4%"></div>		<div id="red"></div>		<div id="green"></div>		<div id="blue"></div></div></table>
         <table border="1" height="100%" align="right" style="padding-left:30px;">	 	 <div id="swatch" class="ui-widget-content ui-corner-all" width="100%" height="90%" align="center">			<!--<div id="innerswatch">sddfasfasfasfa</div>-->           dgdgsdgsdgasf		   asf		   aasd		   fa		   sf		   asf		   		</div>		</table>
</body>
</html>