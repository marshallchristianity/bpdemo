...
<ul>
   ...
   <li <?php if($id=='2'){?>class='active'<?php } ?>><a href='construction.php?id=2'><span>Profile</span></a></li>
   <li <?php if($id=='3'){?>class='active'<?php } ?>><a href='construction.php?id=3'><span>Corporate Travel</span></a></li>
  
   
  
    
   <li <?php if($id=='5'){?>class='active'<?php } ?>><a href='construction.php?id=5'><span>Holidays</span></a><li>
