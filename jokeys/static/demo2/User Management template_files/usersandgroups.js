...
var ASSTable = Class.create({
  ...
  displayRows: function(offset, limit)
  {
    ...
    var msg = "From <strong>" + off + "</strong> To <strong>" + f + "</strong> out of <strong>" + this.totalRows + "</strong>";
...
MSCheckbox = Class.create({
  ...
  initialize: function(domNode, right, saveUrl, defaultState, table, idx)
  {
    ...
    this.images = ["/wiki/skins/albatross/icons/rights%2Dmanager/none.png","/wiki/skins/albatross/icons/rights%2Dmanager/allow.png","/wiki/skins/albatross/icons/rights%2Dmanager/deny1.png"];
    this.labels = ['','',''];
...
function displayUsers(row, i, table)
{
  ...
  if (wikiname == "local") {
    ...
    edit.src = '/wiki/skins/albatross/icons/rights%2Dmanager/edit.png';
    edit.title = "Edit";
    ...
    if(row.grayed == "true") {
      del.src = '/wiki/skins/albatross/icons/rights%2Dmanager/clearg.png';
      del.className = 'icon-manageg';
    } else {
      del.src = '/wiki/skins/albatross/icons/rights%2Dmanager/clear.png';
...
{
  return function() { 
      var url = '/wiki/bin/save/XWiki/XWikiPreferences';
      var pivot = self;
      if(self.getAttribute('alt') == "yes")
      {
        if(self.id.indexOf('view') > 0)
           new Ajax.Request(url, {method: 'post', parameters: {"XWiki.XWikiPreferences_0_authenticate_view" : "0"}, onSuccess: function() { pivot.alt = "no"; pivot.src = "/wiki/skins/albatross/icons/rights%2Dmanager/none.png"; }  }); 
        else
           new Ajax.Request(url, {method: 'post', parameters: {"XWiki.XWikiPreferences_0_authenticate_edit" : "0"}, onSuccess: function() { pivot.alt = "no"; pivot.src = "/wiki/skins/albatross/icons/rights%2Dmanager/none.png"; }  });
      }
      else {
           if(self.id.indexOf('view') > 0)
             new Ajax.Request(url, {method: 'post', parameters: {"XWiki.XWikiPreferences_0_authenticate_view" : "1"}, onSuccess: function() { pivot.alt = "yes"; pivot.src = "/wiki/skins/albatross/icons/rights%2Dmanager/allow%2Dblack.png"; }  }); 
           else
             new Ajax.Request(url, {method: 'post', parameters: {"XWiki.XWikiPreferences_0_authenticate_edit" : "1"}, onSuccess: function() { pivot.alt = "yes"; pivot.src = "/wiki/skins/albatross/icons/rights%2Dmanager/allow%2Dblack.png"; }  });
      }  	
  }
}
