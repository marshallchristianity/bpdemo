<?php
	...
	function db_insert($table_name,$value)
	{
		...
		mysql_query("insert into ".$table_name."(`$columns`) values('$column_values')");
	...
	{	
		...
		echo  $tablevalue="update  ".$table_name." set ".$list." where ".$unique_key[0]." = ".$unique_value[0];  
		 
		mysql_query($tablevalue);	
	}
