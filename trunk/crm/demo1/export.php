<?php 
error_reporting(0);
$connect = mysql_connect('localhost', 'bigperluser','bigperlpwd');
if (!$connect)
{
...
$cid =mysql_select_db('bigperldb',$connect); //specify db name
fopen($_FILES["import"]["tmp_name"], 'r');
define('CSV_PATH','http://grabwebs.com/crm_demo/csvfiles/'); // specify CSV file path
