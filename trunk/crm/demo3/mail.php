...
<h2 style="font-family:Britannic Bold"><span style="color:red">STUDENT</span><span style="color:green">MAIL</span></h2>	
	<form action="mail.php" method="post">
		<?php include("db.php");
		$templates = mysqli_query($link, "select * from mail_tamplates"); ?>
		...
		<?php } ?>
			...
			<input type="hidden" name="check_list" value="<?php echo $_POST['data']; ?>"> 
	...
	<?php if(isset($_POST['ssubmit']) && isset($_POST['subject'])){
	...
	<select name="from" id="from" required>
		...
		<option value="hr@sirmvinstitute.com -:hr123456">hr@sirmvinstitute.com</option>
		<option value="feedback@sirmvinstitute.com -:sirmvinstitute">feedback@sirmvinstitute.com</option>
		<option value="newsletter@sirmvinstitute.com -:sirmvinstitute">newsletter@sirmvinstitute.com</option>
	</select><br/>
