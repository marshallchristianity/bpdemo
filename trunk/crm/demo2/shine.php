...
<form name="" action="" method=post>	
		...
		if(isset($_POST['searching'])){
			$sql = "SELECT * FROM `shinedata` and $_POST[column] like '$_POST[search]%' union
select * from shinedata and $_POST[column] like '%$_POST[search]' union
select * from shinedata and $_POST[column] like '%$_POST[search]%'";
		}else{
