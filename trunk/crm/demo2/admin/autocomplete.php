	...
	<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> STUDENTS</h2>
						<div class="pull-right">
							<a href="admin.php?data=addauto"><button class="btn-primary btn">Add STUDENT</button></a>
						</div>
					</div>
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									...
									<a class="btn btn-info" href="admin.php?data=editauto&page=<?php echo $pages[$i]['id']?>">
	...
	<div class="modal-body">
		...
		<script>
			...
			$(".btn-setting").click(function(){
				...
				$(".yes").attr("href",'dbfiles/autotable.php?page_id='+page_id+"&table=autocomplete");
