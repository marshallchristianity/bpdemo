<div id="content" class="span10">
	...
	<?php
				...
				<?php
					...
					{
				?>
					<div class="alert alert-success">Services has created successfully</div>
				<?php
					}
				?>
	<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> Services</h2>
						<div class="pull-right">
							<a href="index.php?data=addproject"><button class="btn-primary btn">Add Services</button></a>
						</div>
					</div>
					<div class="box-content">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							?>
							<tr>
								<td><?php echo $pages[$i]['name']?></td>
								
								
								
								<td class="center">
									<a class="btn btn-info" href="index.php?data=addimages&page=<?php echo $pages[$i]['id']?>">
										<i class="icon-edit icon-white"></i>  
										Add images                                            
									</a>
									<a class="btn btn-info" href="index.php?data=editproject&page=<?php echo $pages[$i]['id']?>">
										<i class="icon-edit icon-white"></i>  
										Edit                                            
									</a>
									<?php if($pages[$i]['id'] == 4){ ?>
									<a class="btn btn-info" href="index.php?data=video">
										<i class="icon-edit icon-white"></i>  
										add scanner video                                     
									</a>
									<?php }else{ ?>
	...
	<div class="modal-body">
		...
		<script>
			...
			$(".btn-setting").click(function(){
				...
				$(".yes").attr("href",'dbfiles/Servicestable.php?id='+page_id+"&table=services");
