				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						...
						<div class="pull-right">
							<a href="index.php?data=addpage"><button class="btn-primary btn">Add Page</button></a>
						</div>
					</div>
					<div class="box-content">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							?>
							<tr>
								<td><?php echo $pages[$i]['page_title']?></td>
								
								
								
								<td class="center">
									
									<a class="btn btn-info" href="index.php?data=editpage&page=<?php echo $pages[$i]['page_id']?>">
										<i class="icon-edit icon-white"></i>  
										Edit                                            
									</a>
									<a class="btn btn-info" href="index.php?data=addimage&page=<?php echo $pages[$i]['page_id']?>">
										<i class="icon-edit icon-white"></i>  
										add Image                                            
									</a>
									<!--<a class="btn btn-danger btn-setting" href="#" id="<?php echo $pages[$i]['page_id']?>">
	...
	<div class="modal-body">
		...
		<script>
			...
			$(".btn-setting").click(function(){
				...
				$(".yes").attr("href",'dbfiles/pagestable.php?page_id='+page_id+"&table=pages");
