<div id="content" class="span10">
	<!-- content starts -->
	<?php
		$get_pages =get_table_data('service_images',array('service_id'=>$_GET['page']));
		$pagess =get_table_data('services',array('id'=>$_GET['page']));;
	...
	<div>
		<ul class="breadcrumb">
			...
			<li>
				<a href="#"><?php echo $pagess[0]['name']; ?> Service images</a>
			</li>
			<li>
	...
	<div class="row-fluid sortable">	
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" method="post" action="dbfiles/imagestable.php" enctype="multipart/form-data">
						  <fieldset>
							...
							<input type="hidden" name="service_id" value="<?php echo $_GET['page']; ?>">
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> Services image</h2>
						<div class="box-icon">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td>
									<img src="../gallery/<?php echo $get_pages[$i]['images']?>" width="100" height="100">
								</td>
								<td class="center">
	...
	<div class="modal-body">
		...
		<script>
			...
			$(".btn-setting").click(function(){
				...
				$(".yes").attr("href",'dbfiles/imagestable.php?id='+page_id+"&table=service_images");
